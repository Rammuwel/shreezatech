...
<div>
    <x-seo.meta title="Shreeza | Services" description="Explore our comprehensive software development services including web, mobile, AI, cloud, and UI/UX design solutions." />
    <x-services.hero />
    <x-services.services
        :services="$services"
        :offset="$offset"
