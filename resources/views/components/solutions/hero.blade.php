        ...
        href="{{ url('/portfolio') }}"
                ...
                <div
                    ...
                    <img
                        ...
                        class="portfolio-image relative z-0 w-full h-72 sm:h-80 md:h-auto md:w-[30rem] lg:w-[34rem] xl:w-[36rem] object-cover hero-float "
                        alt="Shreeza Tech solutions hero banner">
        ...
        <div class="grid gap-8 md:grid-cols-2 lg:grid-cols-4 p-3">
            ...
            <div class="group flex flex-col items-center justify-center  transition-all duration-500 border-r border-border">
                ...
                <p class=" text-muted leading-7 text-center justify-center">
                    ...
                    Deep domain knowledge across healthcare, finance, education, retail, and more.
            ...
            <div class="group flex flex-col items-center justify-center  transition-all duration-500 border-r border-border">
                ...
                <p class=" text-muted leading-7 text-center justify-center">
                    ...
                    Solutions tailored to your exact workflows, not off-the-shelf templates.
            ...
            <div class="group flex flex-col items-center justify-center  transition-all duration-500 border-r border-border">
                ...
                <p class=" text-muted leading-7 text-center justify-center">
                    ...
                    Connects with your existing systems so rollout is smooth and disruption-free.
            ...
            <div class="group flex flex-col items-center justify-center   transition-all duration-500 ">
                ...
                <p class=" text-muted leading-7 text-center justify-center">
                    ...
                    We stay alongside your business, evolving the solution as your needs grow.
